...
define config.name = _("The Mystical Martmotte 3 - The End Of The Trylogy")
...
define build.name = "TheMysticalMartmotte3-theEndOfTheTrylogy"
...
define config.save_directory = "TheMysticalMartmotte3-theEndOfTheTrylogy-1517508139"
